...
export default async function AgentDashboard() {
  ...
  // ডাটাবেস থেকে এজেন্টের অ্যাসাইন করা পরীক্ষাগুলো নিয়ে আসা (Evaluations টেবিলের সাথে Join করে)
                ...
                <div key={attempt.id} className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex flex-col justify-between">
                  ...
                  {attempt.status === 'ASSIGNED' ? (
                    ...
                    <div className="pt-4 border-t border-gray-100 flex justify-between items-center">
                      <span className="text-sm font-poppins font-medium text-gray-600">Your Score:</span>
